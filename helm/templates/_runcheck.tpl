...
if [ ${OLD_MAJOR_VERSION} -le ${NEW_MAJOR_VERSION} ] || [ ${OLD_CHART_MAJOR_VERSION} -le ${NEW_CHART_MAJOR_VERSION} ]; then
  if ( ! greater_version $OLD_MINOR_VERSION $MIN_VERSION ) || ( ! greater_version $OLD_CHART_MINOR_VERSION $CHART_MIN_VERSION ); then
    ...
    notify "Please follow the upgrade documentation at https://docs.gitlab.com/charts/installation/upgrade.html"
